...
function HighlyAffordable() {
    return (
        ...
        <div className="w-[300px] rounded-xl overflow-hidden shadow-lg border bg-white relative">
            {/* Top-right icon */}
            <button className="absolute top-3 right-3 bg-white p-1 rounded-full shadow-md hover:bg-gray-100">
                <Heart size={18} />
            </button>

            <img className="w-full h-60 object-cover" src="\src\assets\0.jpg" alt="Boho Farm" />
