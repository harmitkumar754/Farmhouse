...
const Listingdiudaman = () => {
  return (
    <div className="px-20 py-8">
      <h2 className="text-2xl font-bold mb-6">Listings with Online Booking Facility in Daman, Dadra and Nagar Haveli and Daman and Diu</h2>
...
export default Listingdiudaman;
